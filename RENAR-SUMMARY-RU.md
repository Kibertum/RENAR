...
**Версия v1.1** | 19.09.2026 | Авторы: Вадим Соглаев, Андрей Юмашев | [renar.tech](https://renar.tech)

## В одном предложении

RENAR — самостоятельный нормативный стандарт, определяющий, как управлять требованиями (BR/SR/TR), спецификациями (12 типов SPEC), тест-кейсами и артефактами адаптации (ADAPT) в проектах, где реализацию производят AI-агенты. Substrate-agnostic: нормативный язык через capabilities V1–V6; конкретный backend (VCS, document store) — выбор реализации.
...
16 нормативных глав (00–15): введение, область применения, положение в типологии методологий, версионирование носителя, термины, роли, иерархия требований, ADAPT, спецификации, тест-кейсы, жизненный цикл и контрольные точки, модель зрелости, метрики, соответствие, нормативные ссылки, язык описания.
...
- **12 типов SPEC (закрытый список):** ARCH / API / DATA / INT / PROC / UI / AI / SEC / OPS / TEST / DOC / UC — параллельная ось к требованиям через граф-связи `constrained-by[]`
- **Комплект описания (v1.1):** BR / SR / SPEC / TC-нормы утверждаются, версионируются и верифицируются вместе — как версия комплекта, а не поартефактно; на каждое утверждение — пара TC-норм (positive + negative) уже при утверждении версии
...
- **12 типов SPEC + тест-кейс как самостоятельный артефакт** — закрытые списки с собственным lifecycle и provenance; добавление типа — только через поправку стандарта.

## Набор документов

| Документ | Назначение |
|----------|------------|
| RENAR Standard | Нормативная спецификация (ОБЯЗАН/РЕКОМЕНДУЕТСЯ/ДОПУСКАЕТСЯ), 16 глав (00–15) |
...
- **PDF:** [Стандарт](https://renar.tech/renar-v1.1-ru-standard.pdf) · [Руководство](https://renar.tech/renar-v1.1-ru-guide.pdf) · [Справочник](https://renar.tech/renar-v1.1-ru-reference.pdf) · [полный архив](https://renar.tech/renar-v1.1-ru.pdf) (RU); [Standard](https://renar.tech/renar-v1.1-en-standard.pdf) · [Full](https://renar.tech/renar-v1.1-en.pdf) (EN)
