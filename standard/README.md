---
title: "Стандарт RENAR v1.1"
order: 1
lang: ru
---
# Стандарт RENAR v1.1

16 нормативных глав. **Это нормативный источник истины** — здесь живут точные «обязан / должен / следует».
...
Главы выстроены в порядке аргумента — читать подряд **00 → 15**. Фундамент (положение в типологии, §2) и инфраструктура носителя (V1–V6, §3) сознательно вынесены вперёд: главы об артефактах (06–10) на них опираются.
...
| 07 | ADAPT | [07-adapt.md](07-adapt.md) | Реактивный мост между ТЗ и требованиями; forward + backward findings; подпись архитектора; ACTZ и итоговое ТЗ |
| 08 | Спецификации | [08-specifications.md](08-specifications.md) | Двенадцать типов SPEC (ARCH…OPS, TEST, DOC, UC) и граф связей с требованиями |
...
| 15 | Язык описания | [15-description-language.md](15-description-language.md) | Контролируемый диалект нормативных разделов артефактов: операторы, глоссарная дисциплина, запрещённые конструкции, атомарность, формы |
...
- **v1.0 (2026-07-17)** — финализация корпуса: снятие draft, приложения #28, тщательный ревью (снятие ADR-011..014 следов). См. [CHANGELOG.md](https://github.com/Kibertum/RENAR/blob/main/CHANGELOG.md).
- **v1.1 (2026-09-19)** — волна партнёрских предложений (ADR-015…026, #30–#54): комплект описания, SPEC-UC, MW, реестр экранов, компонент, первая сторона, глава 15 «Язык описания»; миграция — [guide/12](../guide/12-migration-v11.md).
